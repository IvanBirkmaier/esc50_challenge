    ...
    def __init__(self, root, test_folds=frozenset((1,)), subset="train", download=False):
        ...
        if train:
            ...
            self.wave_transforms = transforms.Compose(
                torch.Tensor,
                transforms.RandomNoise(max_noise=0.1),
                transforms.RandomScale(max_scale=1.25),
                transforms.RandomMute(max_mute=0.3),
                transforms.RandomFrequencyMask(),
            ...
            self.spec_transforms = transforms.Compose(
                ...
                #transforms.RandomFrequencyMask(max_width=32,max_number=4),
            )
